...
const Upload = ({ children, droppable, name, accept, value, onChange, ...props }) => {
    ...
    const handleDragEnter = (e) => {
        ...
        if(e.dataTransfer.item && e.dataTransfer.item.length > 0){
            setDragging(true)
        }
    }
    ...
    return (
        <UploadContainer onClick={handleChooseFile} onDrop={handleFileDrop} onDragEnter={handleDragEnter} onDragLeave={handleDragLeave} onDragOver={handleDragOver} {...props}>
